...
export default async function CerezPolitikasiPage() {
  const content = await prisma.siteSetting.findUnique({ where: { key: "legal_cerez_politikasi" } });
      ...
      <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            kullanılabilir. Bu çerezler ilgili hizmet sağlayıcıların gizlilik politikalarına tabidir
            ve doğrudan bizim kontrolümüzde değildir.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <a href="/kvkk" className="text-honey-dark hover:underline">KVKK Aydınlatma Metni</a>&apos;ni inceleyebilirsiniz.
          </p>
        </section>
