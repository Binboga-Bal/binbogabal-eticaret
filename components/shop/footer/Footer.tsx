    ...
    <footer className="bg-honey-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex items-center gap-3 mt-4">
              {socialLinks.map(({ href, icon: Icon, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="text-honey-dark hover:text-honey-medium transition-colors"
                >
                  <Icon size={20} />
                </a>
              ))}
          ...
          {/* Kurumsal */}
          <div>
            <h4 className="font-bold text-gray-800 mb-4">Kurumsal</h4>
          ...
          {/* Yardım */}
          <div>
            <h4 className="font-bold text-gray-800 mb-4">Yardım</h4>
            <ul className="space-y-2">
          ...
          {/* İletişim */}
          <div>
            <h4 className="font-bold text-gray-800 mb-4">İletişim</h4>
            <ul className="space-y-2">
