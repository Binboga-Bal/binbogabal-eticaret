...
**Binboğa Kooperatif Balı** — a Turkish-language e-commerce platform for selling honey products. Built with Next.js 15 App Router, MySQL (Prisma), NextAuth.js, and integrated with the QNB Pay payment gateway and Dia ERP system.
